...
namespace AssetDisabler
{
    ...
    public class Setting : ModSetting
    {
        ...
        public bool RemovePrefabsButton { set => AssetDisablerSystem.RemovePrefabs(new List<string>() { "RoadMaintenanceVehicle01"}); }
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "AssetDisabler" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RemovePrefabsButton)), "Button" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RemovePrefabsButton)), $"Simple single button. It should be bool property with only setter or use [{nameof(SettingsUIButtonAttribute)}] to make button from bool property with setter and getter" },
